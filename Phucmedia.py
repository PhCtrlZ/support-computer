...
""")
		...
		while True:
			...
			if ngdung=="7":
				...
				os.system("del /f /s /q %systemdrive%\*.pnf")
				os.system("del /f /s /q %systemdrive%\infcache.1")
				os.system("del /f /s /q %systemdrive%\recycled\*.*")
				os.system("del /f /s /q %windir%\*.bak")
				os.system("del /f /s /q %windir%\prefetch\*.*")
				os.system("rd /s /q %windir%\temp & md %windir%\temp")
				os.system("del /f /q %userprofile%\cookies\*.*")
				os.system("del /f /q %userprofile%\recent\*.*")
				os.system("del /f /s /q %userprofile%\Local Settings\Temporary Internet Files\*.*")
				os.system("del /f /s /q %userprofile%\Local Settings\Temp\*.*")
				os.system("del /f /s /q %userprofile%\recent\*.*")
				os.system("RD %windir%\$hf_mig$ /Q /S")
				os.system("del %windir%\2950800.txt /f /q")
				os.system("for /f %%i in (%windir%\2950800.txt) do rd %windir%\%%i /s /q")
				os.system("dir %windir%\$NtUninstall* /a:d /b >%windir%\2950800.txt")
				os.system("rd /s /f /q %temp% /s /q")
				os.system("md %temp%")
				os.system("del /s /f /q C:\Windows\Prefetch\*.*")
				os.system("del /s /f /q C:\Windows\temp\*.*")
				os.system("del /s /f /q C:\Windows\System32\temp\*.*")
